...
```{r}
plot(x=mean_interval$interval,y=mean_interval$steps, type= "l", xlab="Interval (Time)", ylab="Mean Number of Steps", main="Time Series Plot of:
...
```{r}
mean_interval_weekday<- aggregate(steps ~ interval + weekday_factor, new_activitydata_plusweekday,FUN=mean)
require(lattice)
xyplot( steps~interval | weekday_factor, mean_interval_weekday, type = "l", layout=c(1,2),xlab="Interval (time)", ylab="Mean Number of Steps", main="Time Series Plot of:
